...
class FutureAdapter(
    query: Query,
    private val listener: FutureAdapterListener
) : FirestoreAdapter<FutureAdapter.FutureViewHolder>(query) {
    ...
    class FutureViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(snapshot: DocumentSnapshot, listener: FutureAdapterListener) {
            ...
            layout?.setOnLongClickListener {
                listener.moveToCurrentPurchases(notes, snapshot.id)
                true
            }
    ...
    interface FutureAdapterListener {
        ...
        fun moveToCurrentPurchases(notes: Future?, id: String)
    }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FutureAdapter.FutureViewHolder {
        return FutureAdapter.FutureViewHolder(
    ...
    override fun onBindViewHolder(holder: FutureAdapter.FutureViewHolder, position: Int) {
